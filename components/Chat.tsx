    ...
    if (!isAuthorized) {
        return (
          <div className="py-40 flex flex-col items-center justify-center text-center animate-in fade-in duration-700">
            ...
            <p className="text-zinc-500 mb-10 max-w-sm">Enter your Orion Access ID to initialize the terminal.</p>
            <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md px-6">
               <input 
                 ...
                 className="flex-1 bg-zinc-900 border border-zinc-800 p-4 rounded-2xl text-white outline-none focus:border-blue-500 font-mono"
               />
               <button onClick={handleAccess} className="bg-blue-600 px-8 py-4 rounded-2xl font-black text-sm uppercase tracking-widest text-white hover:bg-blue-500 transition-all">
                 Unlock
               </button>
            </div>
          </div>
